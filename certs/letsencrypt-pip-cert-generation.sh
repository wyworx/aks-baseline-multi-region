...
az deployment group create -g $RGNAME -f ./certs/lets-encrypt-resources-custom.json -p location=${LOCATION} subdomainName=${SUBDOMAIN} ipResourceId=${IP_RESOURCE_ID}
